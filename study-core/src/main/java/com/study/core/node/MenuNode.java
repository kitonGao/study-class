package com.study.core.node;

import com.study.core.constant.IsMenu;
...
public class MenuNode implements Comparable{
    ...
    public int compareTo(Object o) {
        ...
        Integer levles = menuNode.getLevels();
        if (num == null){
            num = 0;
        }
        if (levles == null){
        ...
        if (this.levels.compareTo(levles) == 0) {
            return this.num.compareTo(num);
        } else {
            return this.levels.compareTo(levles);
        }
    }
